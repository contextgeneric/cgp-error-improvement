...
Follow the suggestions in `12-error-message-analysis.report.md` to improve the error messages.

You don't need to keep the original format, and you don't need to exactly the suggested format in the report. Instead, think of a new format that can be integrated naturally with `miette`.

If the source JSON error message do not contain sufficient information for you to reconstruct the suggested error message, then omit those details. Do not hard code anything about user-provided code in the code base.
